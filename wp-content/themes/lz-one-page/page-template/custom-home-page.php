		        ...
		        <div <?php if($i == 1){echo 'class="carousel-item active"';} else{ echo 'class="carousel-item"';}?>>
		          	...
		          	<div class="carousel-caption">
			            <div class="inner_carousel">
			              	...
			              	<div class="read-btn">
				              <a href="<?php esc_url(the_permalink());?>" class="" title="<?php esc_attr_e( 'READ MORE', 'lz-one-page' ); ?>"><?php esc_html_e('READ MORE','lz-one-page'); ?>
				              </a>
				            </div>
			            </div>
		          	</div>
	...
	<section id="aboutus">
		<div class="container">
	      <?php if( get_theme_mod('lz_one_page_about_title') != ''){ ?>
	        <h2><?php echo esc_html(get_theme_mod('lz_one_page_about_title','')); ?></h2>
	      <?php }?>
	      <?php
		            ...
		            <div class="row">
		                ...
		                <div class="col-lg-6 col-md-6">
			                <div class="text-aboutus">
			                    ...
			                    <p><?php the_excerpt(); ?></p>
			                    <div class="more-btn">              
			                      <a href="<?php esc_url(the_permalink()); ?>"><?php esc_html_e('READ MORE','lz-one-page'); ?></a>
			                    </div>
			                </div>
		                </div>
		            </div>
