...
function lz_one_page_customize_register( $wp_customize ) {
	...
	$wp_customize->add_setting('lz_one_page_show_site_title',array(
       'default' => true,
       'sanitize_callback'	=> 'sanitize_text_field'
    ));
    $wp_customize->add_control('lz_one_page_show_site_title',array(
       'type' => 'checkbox',
       'label' => __('Show / Hide Site Title','lz-one-page'),
       'section' => 'title_tagline'
    ));

    $wp_customize->add_setting('lz_one_page_show_tagline',array(
       'default' => true,
       'sanitize_callback'	=> 'sanitize_text_field'
    ));
    $wp_customize->add_control('lz_one_page_show_tagline',array(
       'type' => 'checkbox',
       'label' => __('Show / Hide Site Tagline','lz-one-page'),
       'section' => 'title_tagline'
    ));
