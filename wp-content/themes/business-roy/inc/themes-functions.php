 ...
 */
function businessroy_add_sub_toggles_to_main_menu( $args, $item, $depth ) {
    ...
    //if ( isset( $args->show_toggles ) && $args->show_toggles ) {
        ...
        if ( in_array( 'menu-item-has-children', $item->classes, true ) ) {
            ...
            $args->after .= '<button class="toggle sub-menu-toggle fill-children-current-color" data-toggle-target="' . $toggle_target_string . '" data-toggle-type="slidetoggle" aria-expanded="false"><i class="fas fa-angle-down"></i></button>';
...
add_filter( 'nav_menu_item_args', 'businessroy_add_sub_toggles_to_main_menu', 10, 3 );
...
if ( ! class_exists( 'Bussiness_Roy_Walker_Page' ) ) {
    /**
     * CUSTOM PAGE WALKER
     * A custom walker for pages.
     */
    class Bussiness_Roy_Walker_Page extends Walker_Page {
        ...
        public function start_el( &$output, $page, $depth = 0, $args = array(), $current_page = 0 ) {
            ...
            if ( '' === $page->post_title ) {
                ...
                $page->post_title = sprintf( __( '#%d (no title)', 'business-roy' ), $page->ID );
            }
